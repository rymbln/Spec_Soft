...
namespace Diagnostics_FP.Controllers
{
    public class MedicalFormController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetMedicalFormList()
                       select o;
        ...
        //
        // POST: /MedicalForm/Create

        [HttpPost]
        [Authorize] public ActionResult Create(MedicalForm  obj)
        {
            try
            {
        ...
        //
        // GET: /MedicalForm/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            MedicalForm obj = db.GetMedicalForm(id);
            return View(obj);
        }

        //
        // POST: /MedicalForm/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(MedicalForm obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMedicalForm(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachMedicalForm(obj);
                        MedicalForm oldObj = db.GetMedicalForm(obj.MedicalFormID);
        ...
        //
        // GET: /MedicalForm/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteMedicalForm(id);
            }
            catch (DataException)
            {
