...
{
    public class MedicalUnitController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetMedicalUnitList()
                       select o;
        ...
        //
        // POST: /MedicalUnit/Create

        [HttpPost]
        [Authorize] public ActionResult Create(MedicalUnit  obj)
        {
            try
            {
        ...
        //
        // GET: /MedicalUnit/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            MedicalUnit obj = db.GetMedicalUnit(id);
            return View(obj);
        }

        //
        // POST: /MedicalUnit/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(MedicalUnit obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMedicalUnit(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachMedicalUnit(obj);
                        MedicalUnit oldObj = db.GetMedicalUnit(obj.MedicalUnitID);
        ...
        //
        // GET: /MedicalUnit/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteMedicalUnit(id);
            }
            catch (DataException)
            {
