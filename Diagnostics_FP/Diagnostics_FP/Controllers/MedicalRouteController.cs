...
{
    public class MedicalRouteController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetMedicalRouteList()
                       select o;
        ...
        //
        // POST: /MedicalRoute/Create

        [HttpPost]
        [Authorize] public ActionResult Create(MedicalRoute  obj)
        {
            try
            {
        ...
        //
        // GET: /MedicalRoute/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            MedicalRoute obj = db.GetMedicalRoute(id);
            return View(obj);
        }

        //
        // POST: /MedicalRoute/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(MedicalRoute obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMedicalRoute(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachMedicalRoute(obj);
                        MedicalRoute oldObj = db.GetMedicalRoute(obj.MedicalRouteID);
        ...
        //
        // GET: /MedicalRoute/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteMedicalRoute(id);
            }
            catch (DataException)
            {
