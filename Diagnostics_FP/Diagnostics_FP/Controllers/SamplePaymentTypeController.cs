...
{
    public class SamplePaymentTypeController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetSamplePaymentTypeList()
                       select o;
        ...
        //
        // POST: /SamplePaymentType/Create

        [HttpPost]
        [Authorize] public ActionResult Create(SamplePaymentType  obj)
        {
            try
            {
                ...
                {
                    int id = db.AddSamplePaymentType(obj);
        ...
        //
        // GET: /SamplePaymentType/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            SamplePaymentType obj = db.GetSamplePaymentType(id);
            return View(obj);
        }

        //
        // POST: /SamplePaymentType/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(SamplePaymentType obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditSamplePaymentType(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachSamplePaymentType(obj);
                        SamplePaymentType oldObj = db.GetSamplePaymentType(obj.SamplePaymentTypeID);
        ...
        //
        // GET: /SamplePaymentType/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteSamplePaymentType(id);
            }
            catch (DataException)
            {
        ...
        //
        // POST: /SamplePaymentType/Delete/5
