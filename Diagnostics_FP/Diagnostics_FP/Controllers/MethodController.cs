...
namespace Diagnostics_FP.Controllers
{
    public class MethodController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetMethodList()
                       select o;
        ...
        [HttpPost]
        [Authorize] public ActionResult Create(Method  obj)
        {
            try
            {
        ...
        [HttpPost]
        [Authorize] public ActionResult Edit(Method obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMethod(obj);
                    ...
                    {
                        db.DetachMethod(obj);
                        Method oldObj = db.GetMethod(obj.MethodID);
