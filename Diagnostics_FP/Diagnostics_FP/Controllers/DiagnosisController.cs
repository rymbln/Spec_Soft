...
//            var objs = from o in db.GetDiagnosisList()
//                       select o;
...
//        [HttpPost]
//        [Authorize] public ActionResult Create(Diagnosis  obj)
//        {
//            try
//            {
...
//        {
//            Diagnosis obj = db.GetDiagnosis(id);
//            return View(obj);
//        }
...
//        [HttpPost]
//        [Authorize] public ActionResult Edit(Diagnosis obj)
//        {
//            try
//            {
//                if (ModelState.IsValid)
...
//                    resultAction = db.EditDiagnosis(obj);
...
//                    if (id == -1)
//                    {
//                        db.DetachDiagnosis(obj);
//                        Diagnosis oldObj = db.GetDiagnosis(obj.DiagnosisID);
