...
{
    public class OrganismTypeController : Controller
    {
        ...
        public ActionResult jFilter(string q)
            {
                var productNames = from o in db.GetOrganismTypeList().Where(o => o.DescriptionEng.Contains(q)) select o.DescriptionEng;
        ...
        public ViewResult Index(string sortOrder, string currentFilter = "", string searchString = "", int? pageNum = 0)
        {
            ...
            var objs = from o in db.GetOrganismTypeList()
                       select o;
        ...
        //
        // GET: /OrganismType/Edit/5

        [Authorize]
        public ActionResult Edit(int id)
        {
            OrganismType obj = db.GetOrganismType(id);
            return View(obj);
        }

        //
        // POST: /OrganismType/Edit/5
