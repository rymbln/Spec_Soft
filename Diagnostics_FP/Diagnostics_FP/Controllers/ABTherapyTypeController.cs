...
{
    public class ABTherapyTypeController : Controller
    {
        ...
        [Authorize] public ViewResult Index(string sortOrder, string currentFilter = "", string searchString = "", int? pageNum = 0)
        {
            ...
            var objs = from o in db.GetABTherapyTypeList()
                       select o;
        ...
        //
        // POST: /ABTherapyType/Create

        [HttpPost]
        [Authorize] public ActionResult Create(ABTherapyType obj)
        {
            try
            {
                ...
                {
                    int id = db.AddABTherapyType(obj);
        ...
        //
        // GET: /ABTherapyType/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            ABTherapyType obj = db.GetABTherapyType(id);
            return View(obj);
        }

        //
        // POST: /ABTherapyType/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(ABTherapyType obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditABTherapyType(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachABTherapyType(obj);
                        ABTherapyType oldObj = db.GetABTherapyType(obj.ABTherapyTypeID);
        ...
        //
        // GET: /ABTherapyType/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteABTherapyType(id);
            }
            catch (DataException)
            {
