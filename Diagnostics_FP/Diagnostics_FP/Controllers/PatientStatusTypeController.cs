...
{
    public class PatientStatusTypeController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetPatientStatusTypeList()
                       select o;
        ...
        //
        // GET: /PatientStatusType/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeletePatientStatusType(id);
            }
            catch (DataException)
            {
        ...
        //
        // POST: /PatientStatusType/Delete/5
