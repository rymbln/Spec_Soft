...
{
    public class MBBacterioscopyOrganismTypeController : Controller
    {
        ...
        //
        // GET: /MBBacterioscopyOrganismType/
        ...
        {   
            ...
            var objs = from o in db.GetMBBacterioscopyOrganismTypeList()
                       select o;
        ...
        // GET: /MBBacterioscopyOrganismType/Create
        ...
        //
        // POST: /MBBacterioscopyOrganismType/Create

        [HttpPost]
        [Authorize] public ActionResult Create(MBBacterioscopyOrganismType  obj)
        {
            try
            {
                ...
                {
                    int id = db.AddMBBacterioscopyOrganismType(obj);
        ...
        //
        // GET: /MBBacterioscopyOrganismType/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            MBBacterioscopyOrganismType obj = db.GetMBBacterioscopyOrganismType(id);
            return View(obj);
        }

        //
        // POST: /MBBacterioscopyOrganismType/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(MBBacterioscopyOrganismType obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMBBacterioscopyOrganismType(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachMBBacterioscopyOrganismType(obj);
                        MBBacterioscopyOrganismType oldObj = db.GetMBBacterioscopyOrganismType(obj.MBBacterioscopyOrganismTypeID);
        ...
        //
        // GET: /MBBacterioscopyOrganismType/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteMBBacterioscopyOrganismType(id);
            }
            catch (DataException)
            {
        ...
        //
        // POST: /MBBacterioscopyOrganismType/Delete/5
