...
{
    public class ROCharNameController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetROCharNameList()
                       select o;
        ...
        //
        // POST: /ROCharName/Create

        [HttpPost]
        [Authorize] public ActionResult Create(ROCharName  obj)
        {
            try
            {
        ...
        //
        // GET: /ROCharName/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            ROCharName obj = db.GetROCharName(id);
            return View(obj);
        }

        //
        // POST: /ROCharName/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(ROCharName obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditROCharName(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachROCharName(obj);
                        ROCharName oldObj = db.GetROCharName(obj.ROCharNameID);
        ...
        //
        // GET: /ROCharName/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteROCharName(id);
            }
            catch (DataException)
            {
