...
{
    public class AntibioticTypeController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetAntibioticTypeList()
                       select o;
        ...
        //
        // POST: /AntibioticType/Create

        [HttpPost]
        [Authorize] public ActionResult Create(AntibioticType  obj)
        {
            try
            {
        ...
        //
        // GET: /AntibioticType/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            AntibioticType obj = db.GetAntibioticType(id);
            return View(obj);
        }

        //
        // POST: /AntibioticType/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(AntibioticType obj)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        //
        // GET: /AntibioticType/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteAntibioticType(id);
            }
            catch (DataException)
            {
