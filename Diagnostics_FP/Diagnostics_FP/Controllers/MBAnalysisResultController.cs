...
{
    public class MBAnalysisResultController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetMBAnalysisResultList()
                       select o;
        ...
        //
        // POST: /MBAnalysisResult/Create

        [HttpPost]
        [Authorize] public ActionResult Create(MBAnalysisResult  obj)
        {
            try
            {
                ...
                {
                    int id = db.AddMBAnalysisResult(obj);
        ...
        //
        // GET: /MBAnalysisResult/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            MBAnalysisResult obj = db.GetMBAnalysisResult(id);
            return View(obj);
        }

        //
        // POST: /MBAnalysisResult/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(MBAnalysisResult obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditMBAnalysisResult(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachMBAnalysisResult(obj);
                        MBAnalysisResult oldObj = db.GetMBAnalysisResult(obj.MBAnalysisResultID);
        ...
        //
        // GET: /MBAnalysisResult/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeleteMBAnalysisResult(id);
            }
            catch (DataException)
            {
        ...
        //
        // POST: /MBAnalysisResult/Delete/5
