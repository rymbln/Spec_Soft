...
{
    public class FenotypeController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetFenotypeList()
                       select o;
