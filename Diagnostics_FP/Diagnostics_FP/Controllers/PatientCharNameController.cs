...
{
    public class PatientCharNameController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetPatientCharNameList()
                       select o;
        ...
        //
        // POST: /PatientCharName/Create

        [HttpPost]
        [Authorize] public ActionResult Create(PatientCharName  obj)
        {
            try
            {
                ...
                {
                    int id = db.AddPatientCharName(obj);
        ...
        //
        // GET: /PatientCharName/Edit/5

        [Authorize] public ActionResult Edit(int id)
        {
            PatientCharName obj = db.GetPatientCharName(id);
            return View(obj);
        }

        //
        // POST: /PatientCharName/Edit/5

        [HttpPost]
        [Authorize] public ActionResult Edit(PatientCharName obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditPatientCharName(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachPatientCharName(obj);
                        PatientCharName oldObj = db.GetPatientCharName(obj.PatientCharNameID);
        ...
        //
        // GET: /PatientCharName/Delete/5

        [Authorize] public ActionResult Delete(int id)
        {
            try
            {
                db.DeletePatientCharName(id);
            }
            catch (DataException)
            {
