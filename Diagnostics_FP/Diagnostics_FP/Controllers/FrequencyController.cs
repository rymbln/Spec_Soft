...
namespace Diagnostics_FP.Controllers
{
    public class FrequencyController : Controller
    {
        ...
        {   
            ...
            var objs = from o in db.GetFrequencyList()
                       select o;
        ...
        [HttpPost]
        [Authorize] public ActionResult Create(Frequency  obj)
        {
            try
            {
        ...
        {
            Frequency obj = db.GetFrequency(id);
            return View(obj);
        }
        ...
        [HttpPost]
        [Authorize] public ActionResult Edit(Frequency obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    resultAction = db.EditFrequency(obj);
                    ...
                    if (id == -1)
                    {
                        db.DetachFrequency(obj);
                        Frequency oldObj = db.GetFrequency(obj.FrequencyID);
